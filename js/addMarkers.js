AFRAME.registerComponent("create-markers", {
  ...
  init: async function() {
    ...
    dishes.map(dish => {
      ...
      pricePlain.setAttribute("id", `price-plain-${dish.id}`);
      pricePlain.setAttribute("src","https://raw.githubusercontent.com/whitehatjr/menu-card-app/main/black-circle.png");
      pricePlain.setAttribute("width",0.8);
      pricePlain.setAttribute("height", 0.8);
      pricePlain.setAttribute("position", {x:-1.3, y:0, z:0.3});
      pricePlain.setAttribute("rotation",{x:-90, y:0, z:0});
